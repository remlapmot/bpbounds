bpbounds_calc_tri_z3 <- function(p){
  ...
  p10lower = c(p10low1, p10low2, p10low3, p10low4, p10low5, p10low6, p10low7, p10low8, p10low9)
  p10upper = c(p10upp1, p10upp2, p10upp3, p10upp4, p10upp5, p10upp6, p10upp7, p10upp8, p10upp9)
  p11lower = c(p11low1, p11low2, p11low3, p11low4, p11low5, p11low6, p11low7, p11low8, p11low9)
  p11upper = c(p11upp1, p11upp2, p11upp3, p11upp4, p11upp5, p11upp6, p11upp7, p11upp8, p11upp9)
  ...
  if (monoinequality == TRUE) {
    ...
    monop11low = p112
    monop11upp = 1 - p012
    retlist = append(retlist, list("monop10lb" = monop10low,
    ...
    monocrrupp = monop11upp/monop10low
	  retlist = append(retlist, list("monocrrlb" = monocrrlow,
